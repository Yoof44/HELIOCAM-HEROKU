...
<div class="flex-grow flex flex-col items-center justify-center px-4 py-12">
    <div class="bg-[#FF8C42] p-6 flex flex-col justify-center items-center text-white rounded-2xl shadow-xl overflow-hidden w-full max-w-md">
        <h1 class="text-6x1 font-semibold text-gray-200 mb-5">404</h1>
    ...
    <div class="flex justify-center items-center h-screen my-5">
